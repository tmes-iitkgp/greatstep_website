...
function Enviro_CS() {
  ...
  let { contact, phoneno, name, img, info, prize, teamLen, rules, ps, submission } = Comp.find((obj) => obj.id === "Enviro_CS");
  ...
  useEffect(() => {
    ...
    axios
      .get(`/auth/team/getMyTeam/Enviro_CS/${curUser._id}`)
      .then((res) => {
        if (res.data.success) {
          if (res.data.team) {
            ...
            <div id="off_events">
              <div className="off_events">
                      ...
                      <div className="off_events_button tw-text-center">
                        {/* {teamDash ? (
                          <>
                            ...
                            <a target="blank" href="https://forms.gle/r25CZQEue1DivBq56">
                              <button className="custom_btn2">PPT Submission</button>
                            </a>
                          </>
                        ) : (
                          <button
                ...
                <div className="off_events_right">
                  ...
                  {team && <TeamDash event={"Enviro_CS"} team={team} teamSize={teamLen} />}
                </div>
              </div>
            </div>
          </motion.div>
