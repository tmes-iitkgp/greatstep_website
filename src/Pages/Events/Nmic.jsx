...
function Nmic() {
  ...
  let { contact, phoneno, name, img, info, prize, teamLen, rules, ps, submission } = Comp.find((obj) => obj.id === "Nmic");
  ...
  useEffect(() => {
    ...
    axios
      .get(`/auth/team/getMyTeam/Nmic/${curUser._id}`)
      .then((res) => {
        if (res.data.success) {
          if (res.data.team) {
            ...
            <div id="off_events">
              <div className="off_events">
                        ...
                        {teamDash ? (
                          <>
                            ...
                            <div className="off_events_button">
                              <a target="blank" href={submission}>
                                <button className="custom_btn2">Submission</button>
                              </a>
                            </div>
                          </>
                        ) : (
                ...
                <div className="off_events_right">
                  ...
                  {team && (
                    <>
                      <TeamDash event={"Nmic"} team={team} teamSize={teamLen} />
                    </>
                  )}
                </div>
              </div>
