...
function Mine_CS() {
  ...
  let { contact, phoneno, name, img, info, prize, teamLen, rules, ps, submission } = Comp.find((obj) => obj.id === "Mine_CS");
  ...
  useEffect(() => {
    ...
    axios
      .get(`/auth/team/getMyTeam/Mine_CS/${curUser._id}`)
      .then((res) => {
        if (res.data.success) {
          if (res.data.team) {
            ...
            <div id="off_events">
              <div className="off_events">
                      ...
                      <div className="off_events_button tw-text-center">
                        {teamDash ? (
                          <>
                            ...
                            <a target="blank" href="https://forms.gle/ELKUzvHMhWUwyXnS8">
                ...
                <div className="off_events_right">
                  ...
                  {team && (
                    <>
                      <TeamDash event={"Mine_CS"} team={team} teamSize={teamLen} />
                    </>
                  )}
                </div>
              </div>
