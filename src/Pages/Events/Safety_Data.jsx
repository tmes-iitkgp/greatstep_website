...
function Safety_DA() {
  ...
  let { contact, phoneno, name, img, info, prize, teamLen, rules, ps, submission } = Comp.find((obj) => obj.id === "Safety_DA");
  ...
  useEffect(() => {
    ...
    axios
      .get(`/auth/team/getMyTeam/Safety_DA/${curUser._id}`)
      .then((res) => {
        if (res.data.success) {
          if (res.data.team) {
            ...
            <div id="off_events">
              <div className="off_events">
                  ...
                  <div className="off_events-image">
                    ...
                    <div>
                      <div className="off_events_button tw-text-center">
                        {teamDash ? (
                          <>
                            <h2 className="addmember_alert">You have successfully registered, You can now add team members</h2>
                            <div className="off_events_button">
                              <a target="blank" href={"https://forms.gle/JkPwz3obCKY4gv3v7"}>
                                <button className="custom_btn2">Round 1 Submission</button>
                              </a>
                            </div>
                            <div className="off_events_button">
                              <a target="blank" href={"https://forms.gle/iktBrQLEU2ueuvwv7"}>
                                <button className="custom_btn2">Round 2 Submission</button>
                              </a>
                            </div>
                          </>
                        ) : (
                        ...
                        <div className="off_events_button">
                          <a target="blank" href={ps}>
                            <button className="custom_btn1">Problem Statement</button>
                          </a>
                        </div>
                      </div>
                    </div>
                ...
                <div className="off_events_right">
                  ...
                  {team && (
                    <>
                      <TeamDash event={"Safety_DA"} team={team} teamSize={teamLen} />
                    </>
                  )}
                </div>
              </div>
